...
<html>
<head>
    <TITLE>沈狗宠物食品管理系统-V1.0</TITLE>
    <SCRIPT src="../static/js/jQuery/jquery-1.9.1.min.js" type="text/javascript"></SCRIPT>
...
<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
    ...
    <form id="loginForm" method="post" action="toIndex">
    <P style="padding: 30px 0px 10px; position: relative;"><SPAN
            class="u_logo"></SPAN> <INPUT class="ipt" type="text" placeholder="请输入用户名" name="username" value="${user.username}">
    </P>

    <P style="position: relative;"><SPAN class="p_logo"></SPAN>
        <INPUT class="ipt" id="password" name="password" type="password" placeholder="请输入密码" value="${user.password}">
    </P>
        <div id="msg">${msg}</div>
